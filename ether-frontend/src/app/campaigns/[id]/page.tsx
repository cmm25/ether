        ...
        >
          <div className="aspect-video relative overflow-hidden">
            ...
            <div className="absolute top-3 right-3">
              <span className={`px-2 py-1 rounded-full text-xs font-medium ${submission.status === 'approved' ? 'bg-green-500/20 text-green-400' :
            ...
            {submission.currentRank && submission.currentRank <= 5 && (
              <div className="absolute top-3 left-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-sm ${submission.currentRank === 1 ? 'bg-yellow-500 text-black' :
          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${submission.userVoted
        ...
        <div className="max-w-7xl mx-auto p-6 sm:p-8">
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium transition-all ${activeTab === 'leaderboard'
                ? 'bg-purple-600 text-white'
            ...
            <button
              ...
              className={`px-6 py-3 rounded-xl font-medium transition-all ${activeTab === 'submissions'
                ? 'bg-purple-600 text-white'
                : 'bg-gray-800 text-gray-400 hover:text-white'
                }`}
            >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-400 text-sm">Top winners receive a notification to mint their NFTs at campaign end</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
